...
| F0-09 | Nordanis | UI/UX | Diseño de Ticket Fiscal (M-16) en design-system.md §10: formatos 58/80mm, campos fiscales VE, reimpresión marcada y anulación | 🟢 Completado y **mergeado a main** (06/09 — QA VERIFICADO calidad de diseño; LEG-01 en seguimiento; fix QA-F009-01/02 delegado a Nordanis) | 10/09/2026 ✅ |
...
| Ref | Recurso / Célula | Rol | Tarea Asignada | Estado | Fecha Límite |
|-----|------------------|-----|----------------|--------|--------------|
| F1-01 | Nelson | Backend | API CRUD Productos (M-02) con aislamiento tenant | 🟢 Completado y **mergeado a main** (06/09 — `c5a662f`; QA VERIFICADO 2 rondas + rebase QA-F101-01; 104/104; RBAC provisional; hallazgos QA-F101-03..07 en seguimiento) | 26/09/2026 ✅ |
| F1-02 | Nelson | Backend | API CRUD Proveedores (M-03) | 🟡 En Progreso (arranca ya — F1-01 mergeado; incorpora QA-F101-03: validar proveedor_id por tenant + mensaje de error específico) | 30/09/2026 |
| F1-03 | Nelson | Backend | API Configuración de Tienda (M-01) | 🟢 Completado y **mergeado a main** (06/09 — QA VERIFICADO 66/66; hallazgo QA-F103-01 dígito RIF en seguimiento con M-16) | 24/09/2026 ✅ |
| F1-04 | Nelson | Backend | Motor de alertas de mínimo de stock (M-06) | 🔴 | 03/10/2026 |
| F1-05 | Noris | Frontend | Pantallas CRUD Productos/Proveedores/Tienda consumiendo APIs F1-01..03 | 🔵 En Revisión QA → MERGEADO el parcial (06/09 — pantalla Config. Tienda en main; QA VERIFICADO 20/20; continúa con pantallas Productos sobre API F1-01 ya mergeada; incorpora QA-SR02-01 single-flight refresh y QA-F105-01/02) | 10/10/2026 |
...
| Ref | Recurso | Rol | Tarea Asignada | Estado | Fecha Límite |
|-----|---------|-----|----------------|--------|--------------|
| ST-01 | Alfredo | DevOps | Deploy staging online restringido: stack completo, TLS dev, BT-01/BT-02 incluidos, datos de prueba | 🟢 Completado y **mergeado a main** (05/09 — `66e5ad6`) | 05/09/2026 ✅ |
| ST-02 | Emilio | QA | Smoke test post-deploy sobre staging online (login/refresh/logout/dashboard) | 🟢 Completado (05/09 — ✅ **VERIFICADO 7/7**; 4 hallazgos QA-ST02-01..04, ninguno bloquea merge; autoriza entrega a inversor) | 05/09/2026 ✅ |
| SR-01 | Lead_Blue | Blue Team | Revisión de seguridad del patrón de aislamiento tenant en F1-03 (patrón que replica F1-01+) — solo lectura, no bloquea merge | 🟢 Completado (05/09 — **SEGURO CON OBSERVACIONES**; 9 hallazgos BT-SR01-01..09; BT-SR01-01 remediado por Nelson `e87e9ea`) | 05/09/2026 ✅ |
| SR-02 | Nelson + Alfredo | Backend + DevOps | Remediación QA-ST02-01 (Alta): habilitar rotación de refresh token — default backend + config staging + redeploy | 🟢 Completado backend y **mergeado a main** (06/09 — fix `5c4853b`, QA VERIFICADO 45/45; kill-switch operacional; **QA-SR02-01 single-flight frontend delegado a Noris antes de deploy conjunto**) | 08/09/2026 ✅ (backend) |
| SR-03 | Alfredo | DevOps | Remediación QA-ST02-02 (Media): CSP proxy (font-src data: + hash script inline) + verificación pyjwt en imagen (N-F101-02) | 🟡 En Progreso (despacho interrumpido por límite de tasa — reemitir) | 08/09/2026 |
| LEG-01 | Wilfredo | Legal/Compliance | Validación normativa VE del Ticket Fiscal (N-F009-04..08): naturaleza del comprobante, leyendas reimpresión/anulación, alícuotas IVA, formato factura | 🔴 Pendiente (delegación emitida 05/09 — `docs/plantillas/DELEGACION-LEGAL-F0-09-WILFREDO.md`) | 12/09/2026 |
